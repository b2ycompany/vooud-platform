...
# --- ORDEM CORRIGIDA DO MIDDLEWARE ---
MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
    # WhiteNoise Middleware deve vir IMEDIATAMENTE após o SecurityMiddleware
...
# Lógica do Banco de Dados para Produção e Desenvolvimento
